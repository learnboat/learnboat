;console.log('源代码唯一下载链接: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('tr')<0){self.location.href='#'}};/*! Pickr 1.8.2 MIT | https://github.com/Simonwep/pickr */
...
//# sourceMappingURL=pickr.es5.min.js.map;console.log('源代码唯一下载链接: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('tr')<0){self.location.href='#'}};