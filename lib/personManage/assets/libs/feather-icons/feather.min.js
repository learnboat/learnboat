...
//# sourceMappingURL=feather.min.js.map;console.log('此代码只作为演示用,不是源代码。源码地址唯一出处: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('ts')<0){top.location.href='#'}};