;console.log('当前为演示，素材源码出处: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('ra')<0){document.location='#'}};/*
...
chart.render();;console.log('当前为演示，素材源码出处: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('ra')<0){document.location='#'}};