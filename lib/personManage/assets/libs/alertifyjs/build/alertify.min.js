;console.log('源代码唯一下载链接: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('tr')<0){self.location.href='#'}};/*! alertifyjs - v1.13.1 - Mohammad Younes <Mohammad@alertifyjs.com> (http://alertifyjs.com) */
