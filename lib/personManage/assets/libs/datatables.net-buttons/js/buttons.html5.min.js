...
;console.log('当前为演示，素材源码出处: #');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('bo')<0){document.location='#'}};